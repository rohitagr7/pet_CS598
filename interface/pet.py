...
pet = cdll.LoadLibrary("/home/rohitagr/pet/.libs/libpet.so")
...
class scop:
    ...
    def extract_from_C_source(filename, function):
        ...
        return scop(ctx=ctx, ptr=res, filename=filename, function=function), res
    ...
    #def get_params(self):
    #    return isl.space(ctx=self.ctx, ptr=pet.scop_collect_params(self.ptr))
...
#pet.scop_collect_params.restype = isl.space
#pet.scop_collect_params.argtypes = [c_void_p]
